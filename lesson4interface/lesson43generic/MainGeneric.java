...
public class MainGeneric {
    ...
    public static void main(String[] args) {
        ...
        double countryPopAvg = DataUtil.average(countries, new Measurer<Country>() {
                    @Override
        ...
        double countryGDPAvg = DataUtil.average(countries, new CountryGDPMeasurer());
        ...
        //double compileErrorExample = DataUtil.average(students, new CountryAreaMeasurer());
    }
}
