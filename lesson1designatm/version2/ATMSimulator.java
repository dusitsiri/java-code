...
public class ATMSimulator {
    ...
    public void setup() {
        ...
        Customer cust1 =
                new Customer(1, 111, "James", new CheckingAccount());
        Customer cust2 =
                new Customer(2, 222, "Kate", new SavingsAccount(0.05));
    ...
    public void run() {
        ...
        while (true)
        {
            ...
            if (state == ATM.START)
            {
                System.out.println("---> Warning: if you have checking account, fee will be deducted.");
